...
| — | **G9 Slice 3** conflict-copy (detect `.dirty` id whose server `updatedAt` beats baseline → keep both) · **G10 follow-ons** *(list/doc inbound, shared-token resolve, Universal-Links via A2)* · **G11 presence** *(optional)* | ⏳ remaining |
